...
<tileset version="1.10" tiledversion="1.11.2" name="Tileset_StagnantWaterBlue" tilewidth="16" tileheight="16" tilecount="56" columns="7">
 <image source="../../classic_dungeons_stagnant_water_blue.png" width="112" height="128"/>
 <wangsets>
  <wangset name="Stagnant Water" type="corner" tile="-1">
   <wangcolor name="Deep Water" color="#0000aa" tile="-1" probability="1"/>
