...
<tileset version="1.10" tiledversion="1.11.2" name="Tileset_FloorWallEdges" tilewidth="16" tileheight="16" tilecount="56" columns="7">
 <image source="../../classic_dungeons_stone_floor_wall_edges.png" width="112" height="128"/>
 <wangsets>
  <wangset name="Floor Wall Edge" type="corner" tile="-1">
   <wangcolor name="Wall Edge" color="#888888" tile="-1" probability="1"/>
