...
export class ProceduralWorld {
   ...
   */
  getEntity(id: number) {
    // biome-ignore lint/suspicious/noExplicitAny: ecsy World has no public entityManager type
    ...
    // biome-ignore lint/suspicious/noExplicitAny: ecsy internal entity type is untyped
