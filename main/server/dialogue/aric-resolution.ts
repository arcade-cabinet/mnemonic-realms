export default async function (player: RpgPlayer) {
  ...
  await player.showText({
    text: "Curator. The Gallery subjects are waking up. They're confused but alive. Someone needs to help them adjust.",
    speaker: 'Aric', // Assuming 'Aric' is the ID for Aric's character graphic
  });
}
