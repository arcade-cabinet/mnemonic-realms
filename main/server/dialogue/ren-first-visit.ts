...
export default async function (player: RpgPlayer) {
  ...
  if (player.getVariable('DIALOGUE_REN_FIRST_VISIT_PLAYED')) {
    return; // Dialogue already played, exit
  }

  // Ren: "The Bright Hearth — best inn in the village! Well, only inn. Rest your feet, rest your mind."
  ...
  player.setVariable('DIALOGUE_REN_FIRST_VISIT_PLAYED', true);
}
