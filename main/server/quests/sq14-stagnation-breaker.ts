...
const quest: QuestFileExport = {
  ...
  act: 'act3',
  objectives: [
    { index: 0, description: 'Speak with Artun about freeing Hana' },
    ...
    { index: 3, description: "Broadcast potency 4+ joy fragment into Hana's frozen form" },
    { index: 4, description: "Witness Hana's partial awakening message" },
    { index: 5, description: "Return to Artun with Hana's message" },
  ],
