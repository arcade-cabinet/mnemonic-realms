...
|-----------|-------|---------------|-------|
| Hana | Warm, practical, direct | Short sentences, active verbs, occasional humor | Flowery language, passive voice |
| Artun | Kind, scholarly, measured | Longer sentences, reflective pauses, historical references | Slang, urgency |
| Grym | Elegant, calm, pained | Measured cadence, rhetorical questions, precise diction | Shouting, cruelty, gloating |
| Janik | Professional, evolving | Military brevity early, philosophical later | Casual speech, contractions (early) |
| Khali | Cheerful, chatty | Exclamations, product descriptions, friendly asides | Negativity, formality |
| Hark | Gruff, proud | Short declaratives, craft metaphors | Verbosity, sentimentality |
| Nyro | Welcoming, gossipy | Questions, rumors, observations about guests | Rudeness, indifference |
| Vash | Quiet, precise | Academic vocabulary, careful qualifiers | Small talk, emotional outbursts |
| Nel | Bold, adventurous | Action-oriented, directional language, "the trail" metaphors | Sitting still, hesitation |
| Reza | Patient, reverent | Light metaphors, soft tone, gentle corrections | Aggression, cynicism |

---

## Part 1: Named NPC Dialogue — Hana

Hana is a traveling Mnemonic Architect, mid-30s, practical and warm. She is the player's mentor in Act I, frozen at the Act I climax, freed in Act II, and a full companion through Act III. ~35 unique dialogue entries.
...
**Hana** *(after first victory)*: Not bad at all. You're a natural.

**Hana** *(before Meadow Sprite fight)*: Now a real one. This little sprite wandered in from the fields south of here. It won't go easy on you — but it won't go hard, either.
...
**Hana** *(after broadcast, softly)*: That was my memory — the first time I ever did this, years ago. And now you've given it back to the world. Better than it was.
...
**Hana** *(after collecting 3 fragments)*: Three fragments from a single site — that's a rich deposit. The Dissolved who gathered here must have shared deep memories before they let go. We should use these wisely.
...
**Hana** *(in grotto)*: Three-star fragments. From the Dissolved era. These are powerful — don't waste them on small broadcasts. Save them for when you really need to push back against something.
...
**Hana** *(responding to scout)*: You call this safe? You've frozen an entire watchtower.

**Hana** *(after scout leaves)*: The Preservers. That's who made the clearing in Heartfield. That's who's doing this.
...
**Hana** *(after shattering, grinning)*: There. That's what it looks like when the world starts breathing again.
...
#### Trigger: Stagnation expansion — Hana rescues farmer (Scene 11)
Location: Heartfield — Stagnation Clearing (expanded)

**Hana**: No. No, no — it's bigger. Much bigger. They're reinforcing it.

**Hana** *(to frozen farmer)*: I'll get her. You — stay back.

**Hana** *(after rescuing farmer)*: Run. Get to the village. Everyone, GO.
...
*[Hana is frozen mid-stride. No further dialogue until freed in Act II.]*

### Act II Dialogue (Post-Freedom)

#### Trigger: Hana freed from expanded Stagnation Zone
Location: Heartfield — Stagnation Clearing
Context: Player broadcasts potency 4+ fragment after all 4 god recalls.

**Hana** *(gasping, first words after weeks of stasis)*: I... how long?

**Hana**: I remember the crystal closing. I remember reaching for the anchor stone. And then... nothing. A perfect, silent nothing.

**Hana**: It wasn't terrible. That's the worst part. If it had hurt, I could hate them for it. But it was just... still. And I'm not built for still.

**Hana**: Thank you. Now tell me everything I missed — and then let's go finish what we started.

#### Trigger: Hana rejoins party
Location: After freedom dialogue

**Hana**: I can feel the gods you recalled. Four of them — the world is louder, brighter, more alive than when I went under. You did that. Without me.

**Hana**: Don't get used to working alone, though. I owe Grym a conversation.

#### Trigger: Artun introduction to Hana (if they haven't met in Act II)
Location: Any map, after Hana rejoins

**Hana** *(to Artun)*: So you're the scholar Artun's been writing about in those letters. The one who studies dissolving civilizations.

**Artun**: And you're the woman who ran into a stagnation zone to punch a crystal. We're both exactly what I expected.
...
**Hana** *(tense, to Janik)*: Step aside, Janik.

**Hana**: Grym's route. They've crystallized a route through the Sketch — freezing it into solidity instead of remembering it. The crystal road leads toward the Fortress.
...
#### Trigger: Archive of Perfection — Hana's Insight (Scene 7)
...
#### Trigger: Grym confrontation (Scene 8)
Location: Preserver Fortress Floor 3 — First Memory Chamber

**Hana** *(responding to Grym)*: I was frozen. I was inside the crystal, in the silence you're describing. It wasn't terrible. But it wasn't alive, either.
...
**Hana** *(after Artun suggests a new question)*: What do you mean?
...
**Artun**: You taught the combat. I taught the wisdom.
...
**Hana** *(turning to the player)*: What will YOU create next?

### Ambient / Overworld Dialogue (Non-Scripted)

These lines trigger when the player talks to Hana outside of scripted scenes.
...
**Hana** *(Ambergrove)*: Listen to the trees. Every one of them is humming. The Dissolved planted a whole symphony here.

**Hana** *(Millbrook)*: I could retire to a town like this. River, bridges, good fish. Maybe someday.

**Hana** *(Sunridge)*: Wind's sharp up here. But the view... you can see the whole world being built, right at the edges.

**Hana** *(in combat, low HP)*: Little help here!

**Hana** *(in combat, healing)*: Hold still — I've got you.

**Hana** *(after combat victory)*: Not bad. Getting better every fight.

#### Act III Ambient (post-freedom)

**Hana** *(Frontier zones)*: Everything's changed since I went under. The gods... I can feel them. All four.

**Hana** *(Sketch zones)*: The Sketch is terrifying and beautiful. Like standing at the edge of a thought that hasn't been finished yet.

**Hana** *(before boss fights)*: Together. We do this together.
...
**Artun**: I'm too old to stay behind and too curious to let you go alone. The Frontier has answers I've been chasing for forty years.

**Artun**: I won't be much use in a fight — my knees aren't what they were. But I know things about the Dissolved that might save your life out here. And I can read Resonance Stones faster than anyone alive.
...
**Artun** *(witnessing recall)*: Forty years of study. Forty years of reading journals and tracing patterns and wondering if the dormant gods were even real. And now I'm watching one wake up.

**Artun**: I thought I'd cry. I'm not crying. I'm too amazed to cry.

#### Trigger: Rootwalker's Last Garden (Act II moral dilemma)
Location: Shimmer Marsh area

**Artun**: The Rootwalker asked to be crystallized. She chose stasis. Not because she was afraid of dissolution — because her garden was her life's work and she couldn't bear the thought of it changing without her.

**Artun**: Sometimes preservation IS the right answer. Not always. Not even often. But sometimes.

#### Trigger: The Songline (Depths Level 4)
Location: Depths Level 4

**Artun**: The Choir of the First Dawn. This is their last song — the one they sang as they dissolved. Five verses, each one a generation's worth of memory compressed into a single phrase.

**Artun**: Listen. Don't just hear it — listen. They weren't sad. They were complete.

#### Trigger: Grym's endgame reveal (Act II Scene 17)
Location: After Janik's ambush

**Artun**: Grym intends to crystallize the First Memory. If they succeed, the world stops asking questions. It stops wondering. It stops growing.

**Artun**: We need to reach the Sketch before they do.
...
**Artun** *(sitting on the cave floor)*: A question. The world exists because someone asked a question. And Grym wants to answer it with silence.
...
**Artun** *(proposing the remix)*: "Why do things change?" That question created the world. But the world has grown beyond that question — it's bigger now, richer, more complex. It doesn't need the old question anymore. It needs a new one.
...
**Artun** *(Elder's House, pre-Hana's freezing)*: Be careful out there. The world's safer than it looks, but it's bigger than you think.

**Artun** *(Elder's House, post-stagnation discovery)*: The Dissolved records mention "crystal sickness" — places where time stops. I always thought it was metaphor. It's not.

**Artun** *(Lookout Hill)*: On a clear day, you can see the Frontier shimmer. Just barely. Like heat rising off summer roads, except it never stops.

#### Act II Ambient (party member)

**Artun** *(Frontier zones)*: Everything out here is thinner. Less remembered. You can feel the world's edges if you pay attention.

**Artun** *(after any god recall)*: I need to update my journals. This changes everything we thought we knew.

**Artun** *(near Resonance Stones)*: May I? I want to listen before you collect. Sometimes the stone tells a story the fragment can't hold.

**Artun** *(in combat, low HP)*: I'm no fighter — help an old man out!

**Artun** *(in combat, using skill)*: The Dissolved had a phrase for this: "knowing is the first wound."

#### Act III Ambient

**Artun** *(Sketch zones)*: The Dissolved who planned all this... they had such ambition. They imagined entire worlds and left them for us to finish.

**Artun** *(Preserver Fortress)*: Grym built something beautiful here. That's what makes it so hard.

---

## Part 3: Named NPC Dialogue — Grym

Grym is the primary antagonist. Elegant, calm, a true believer. They speak in measured tones, ask rhetorical questions, and never gloat. They are wrong, but they are sincere. ~25 unique entries.

### Act I Dialogue

#### Trigger: Hana's freezing — voice from crystal (Scene 11)
Location: Heartfield — expanded Stagnation Zone

**Grym** *(echoing, calm)*: I did not want this.
...
#### Trigger: After 3 god recalls — Grym's voice through Resonance Stone
Location: Any Frontier zone, ambient trigger

**Grym** *(through a Resonance Stone, uninvited)*: You've recalled three of them now. The dormant gods. Unfinished things, completed by force.

**Grym**: Did you ask them if they wanted to wake? Did the Choir's prototype choose to become a storm? Did the Rootwalkers' seed choose to bloom?

**Grym**: You impose your vision on the world and call it growth. I preserve what already exists and you call it stagnation. We are not so different, Architect.

#### Trigger: Grym's endgame reveal (Act II Scene 17)
Location: Via crystal projection after Hana's freedom

**Grym**: You've freed your friend. I expected that. The crystal was never meant to hold her forever — only long enough for me to finish.

**Grym**: The First Memory — the world's original question — sits at the heart of my Fortress. When I crystallize it, the question stops being asked. The cycle of wonder-create-dissolve ends. No more civilizations rising and falling. No more loss.

**Grym**: You think this is evil. I think it is mercy. Come to the Fortress and we'll see which of us is right.

### Act III Dialogue

#### Trigger: Grym's Right Hand pre-combat line (Scene 6)
Location: Preserver Fortress Floor 1

**Grym's Right Hand**: Grym weeps for every battle. So do I. But these moments — these perfect, frozen moments — they're worth protecting. Even from you.

**Grym's Right Hand** *(defeated)*: Grym is below. They know you're coming. They've always known.
...
**Archive Keeper** *(defeated, whispering)*: Grym... will understand.
...
**Grym** *(voice breaking, slightly)*: I've watched it happen. Not personally — I'm not that old. But through the crystal. Through the frozen memories I've collected. I've seen the pattern: ask, answer, dissolve. Ask, answer, dissolve. An endless cycle of civilizations creating beautiful things and then ceasing to exist.
...
**Grym** *(responding to Artun)*: The world exists WHETHER it asks questions or not. The mountains don't need to wonder why they erode. The rivers don't need to wonder why they flow. They just ARE. I want the world to just BE.

**Grym** *(responding to Hana)*: Were you suffering?

**Grym** *(quietly, after Hana says "I couldn't choose")*: Choice is what leads to dissolution.

**Grym** *(to the player)*: You've recalled four gods. Permanent choices, made with single emotions, reshaping deities that the Dissolved left unfinished. You've broken stagnation zones, freed frozen people, shattered my cathedral.
...
**Grym** *(special line)*: You're consistent. You chose one feeling and committed to it. Four times. I don't agree with your choice — but I respect the commitment. That's more than most people manage.
...
**Grym** *(after Janik reports Gallery subjects waking)*: Then that's what we'll do. The Preservers built a museum. Perhaps it's time we became librarians instead — not freezing memories, but keeping them. Sharing them. Letting people borrow what they need and bring it back changed.

**Grym**: An archive, not a prison.

### Post-Game Dialogue

#### Trigger: Player talks to Grym at de-crystallized Fortress
Location: Preserver Fortress (post-bloom)

**Grym**: Welcome back, Architect. Would you like me to archive your journey? I can preserve the key moments — not freeze them, just... record them. For anyone who wants to see what you did.

**Grym**: I'm learning the difference between keeping a memory and caging it. It's harder than I expected. But the Gallery subjects have been patient teachers.

---

## Part 4: Named NPC Dialogue — Janik

Preserver Captain Janik is a recurring figure who evolves from dutiful enforcer to philosophical questioner to ally. His speech shifts from military precision to open vulnerability. ~15 unique entries.
...
**Janik**: Halt. You're entering Preserver-monitored territory. State your purpose.

**Janik**: A Mnemonic Architect. Grym warned us one might come. You're permitted to pass — for now. We observe. We do not yet obstruct.

**Janik**: A word of advice: the Frontier is not the Settled Lands. Things here are fragile. Unfinished. Be careful what you remember into existence. Not everything should be finished.

#### Trigger: Second encounter — after first god recall
Location: Any Frontier zone (ambient trigger, post-first recall)

**Janik**: You recalled a god. I felt it — we all did. The whole Frontier shuddered.

**Janik**: Grym's lieutenants are panicking. I'm not panicking. I'm thinking.

**Janik**: Does being stronger make you right? Honest question. I don't know the answer. But I think you should ask it before you recall another one.
...
**Janik** *(blocking the path)*: I can't let you pass. Not because I agree with what's inside — but because orders are orders, and I'm not ready to break them.

**Janik** *(if player persists)*: Then we fight. And afterward, one of us will have to live with being wrong.

#### Trigger: After 3 recalls — Janik's ambush
Location: Frontier zone (scripted encounter)

**Janik**: Architect. I need to talk to you. Not fight — talk.

**Janik**: Three gods recalled. The Frontier is transforming. My scouts report Preserver zones cracking, stagnation failing, crystal crumbling. Grym's response is to accelerate the plan — crystallize the First Memory before you can reach it.

**Janik**: I was given orders to stop you. These are those orders.

*[Janik sets his crystal gauntlet on the ground.]*

**Janik**: I'm choosing not to follow them.

**Janik**: I still don't know if you're right. But I know Grym is rushing, and people who rush make mistakes. So I'll stay out of your way. This time.

### Act III Dialogue

#### Trigger: Fortress Gate — Janik's intelligence briefing (Scene 3)
Location: The Undrawn Peaks — Crystalline Fortress Gate (20, 35)
...
#### Trigger: Endgame Bloom — Janik at Fortress Gate (Scene 11)
Location: Preserver Fortress Gate (exterior)
...
#### Trigger: Player talks to Janik at Fortress
Location: Preserver Fortress entrance (post-bloom)

**Janik**: I'm staying here. Someone needs to watch the Fortress — not to guard it, but to welcome visitors. Grym is building their archive inside. I'll make sure no one confuses keeping with caging again.

**Janik**: You asked me once, by implication, why I followed orders I doubted. The answer was fear. Not of Grym — of being wrong. It's easier to follow than to choose.

**Janik**: I'm choosing now.
...
**Khali** *(browse)*: Take a look! Potions, antidotes, and the odd curiosity. Stock gets better as the village brightens up — your broadcasts are good for business!

**Khali** *(buy)*: Excellent choice! That'll serve you well out there.

**Khali** *(buy — expensive item)*: Ooh, going for the premium goods! You've earned it.

**Khali** *(sell)*: I can take that off your hands. Fair price, always.

**Khali** *(insufficient gold)*: Ah, not quite enough gold for that one. Come back when your pockets are heavier — I'll hold it for you.

**Khali** *(farewell)*: Safe travels! Come back anytime — the door's always open.

#### Ambient Lines

**Khali** *(Act I)*: The Memorial Garden's been looking brighter lately. I swear the flowers are bigger since you arrived.

**Khali** *(Act II, post-Hana's freezing)*: Hana... I didn't know her well, but I sold her supplies every week. She always bought extra, "just in case." I hope your "just in case" brings her back.

**Khali** *(Endgame Bloom)*: Everything in my shop is glowing. Not metaphorically — literally glowing. I may need to adjust my prices.
...
**Hark** *(browse)*: Steel, leather, and honest craft. No enchantments — I leave the magic to you Architects.

**Hark** *(buy)*: Good blade, that. Treat it right and it'll return the favor.

**Hark** *(sell)*: I'll melt it down and make something better. Nothing goes to waste.

**Hark** *(insufficient gold)*: Can't give it away, friend. Gold talks. Come back when it's louder.

**Hark** *(farewell)*: Keep your guard up.

#### Ambient Lines

**Hark** *(Act I)*: The steel sings different when the village is bright. I don't know why. Maybe the metal remembers being ore.

**Hark** *(Act II)*: I made Hana's workshop tools. Precision work — she was particular about the balance. I'll make her new ones when she's free.

**Hark** *(Endgame Bloom)*: The metal sings when I hammer it now. I've been a smith for twenty years and the metal has never done that.
...
**Nyro** *(rest)*: Sweet dreams. The beds are soft and the walls keep out the worry.

**Nyro** *(rest — post Act I)*: Rest well. You've earned it more than most. I'll wake you if anything happens.

**Nyro** *(talk — rumor system)*: I heard from a merchant that... *(delivers zone-specific hints based on current quest state)*

#### Ambient Lines

**Nyro** *(Act I)*: A traveler came through last week talking about frozen butterflies south of here. Gave me chills. Not the good kind.

**Nyro** *(Act II)*: Frontier folk have been passing through more often. They say the wind sounds different up north — like music, almost.

**Nyro** *(Endgame Bloom)*: Guests are dreaming in color. One woman woke up and said she dreamed in music. I don't know what that means, but she left a five-star review.
...
**Vash**: Ah. A visitor. Unusual. I'm Vash — I study the Dissolved from this hut. The marsh is rich with their memories. Quieter than a library, and far more honest.

**Vash**: You're an Architect, aren't you? I can tell by the way you look at the water — like you're reading it. Most people just see reflections.

**Vash**: There's a glade south of here. Verdance's Hollow. The tree there has been pulsing stronger this past month. Something's waking up. I'd investigate myself, but I don't move fast enough for what lives between here and there.

#### Ambient Lines (pre-recall)

**Vash**: The Dissolved chose to become the world. That's not death — it's graduation. They completed their purpose and trusted the future to carry it forward.

**Vash**: The marsh remembers everything. Every raindrop, every root, every creature that ever swam through its waters. The trick is learning to listen without drowning in the detail.

#### Post-Verdance Recall Lines

**Vash** *(if Floriana — joy)*: The Hollow is blooming. I've cataloged twelve new species this morning alone. This is the happiest the marsh has been in centuries.

**Vash** *(if Thornweald — fury)*: The growth is... aggressive. Vines are reclaiming the stagnation zones faster than the Preservers can reinforce them. I'm alarmed and delighted in equal measure.

**Vash** *(if Autumnus — sorrow)*: An eternal autumn. Leaves falling, roots composting, new shoots emerging from the decay. The Rootwalkers would have understood this perfectly.

**Vash** *(if Sylvanos — awe)*: The root network is visible now — a web of luminous threads beneath the water. The entire marsh is interconnected. I can feel it when I stand in the shallows.

#### Endgame Bloom

**Vash**: Verdance's Hollow is a forest now. Not a glade — a proper forest. It grew overnight. I've been cataloging species I've never seen before.

### Nel (Ridgewalker Camp Leader)

#### Trigger: First visit
Location: Hollow Ridge — Ridgewalker Camp (15, 25)

**Nel**: Welcome to the edge of the map! I'm Nel — we Ridgewalkers live here because we like watching new land form. Most people think we're mad. We think we're lucky.

**Nel**: You're the Architect from the village? Artun sent a letter ahead. He says you're heading to the shrines. Good — the Spire's been shaking harder these past weeks. Something up there wants to wake up.

**Nel**: Need supplies? Rest? Directions? We've got a merchant who visits on rotation and a view that'll make you forget your name.

#### Ambient Lines

**Nel**: The mountains aren't still. They grow. Slowly, sure — but I've measured it. New peaks every decade. This world isn't finished, and neither are we.

**Nel**: The Preservers sent scouts last month. We told them politely that this is our mountain and they should crystallize somewhere else. They left. Politely.

#### Post-Kinesis Recall Lines

**Nel** *(if Jubila — joy)*: The pass is open! The Spire stopped shaking and the whole ridge smoothed out like a road. Jubila's work, I'd wager. The mountains want us to travel.

**Nel** *(if Tecton — fury)*: The Shattered Pass exploded. Not metaphorically — rock and ice everywhere. But the new path is wider and stronger. Tecton doesn't do things by halves.

**Nel** *(if Errantis — sorrow)*: The footprints... I can see them now. Paths the Peregrine Road walked centuries ago, glowing on the stone. It's like reading a love letter written in geography.

**Nel** *(if Vortis — awe)*: The Spire is a sculpture now. Orbiting rocks, spiraling energy — I could watch it all day. Vortis turned our landmark into a wonder.

#### Endgame Bloom

**Nel**: The mountains are finishing themselves. New peaks appearing, new passes opening. We've never had so much to explore.

### Reza (Flickerveil Elder)

#### Trigger: First visit
Location: Flickerveil — The Flickering Village (35, 30)

**Reza**: Hello, dear. I'm Reza. I've been studying the grove — Luminos Grove, they call it — since I was a girl. The light there is... patient. It's been waiting for someone who can see it properly.

**Reza**: Take this. A Light Lens — I polished it from a crystal I found at the grove's edge. Without it, the light is too bright to approach. With it, you'll see the path.

#### Ambient Lines

**Reza**: The flickering is beautiful if you don't think about it too hard. The trees can't decide if they're real or sketched. I've come to find it charming.

**Reza**: Light reveals. That's all it does. The question is whether you're ready for what it shows you.

#### Post-Luminos Recall Lines

**Reza** *(if Solara — joy)*: The golden dawn... I've waited my whole life for this. The flickering is gone — replaced by warm, steady light. Solara's gift.

**Reza** *(if Pyralis — fury)*: The light is harsh now. Every shadow is sharp, every flaw exposed. Pyralis shows truth whether you want it or not. I'm still deciding if that's a blessing.

**Reza** *(if Vesperis — sorrow)*: Twilight. Permanent, gentle twilight. The trees have settled into a golden-hour glow that makes everything feel like the last hour before sleep. It's beautiful and it makes me weep.

**Reza** *(if Prisma — awe)*: The forest is a kaleidoscope! Every surface refracts differently. The children are beside themselves. I've been cataloging the color variations — I'm up to 347 and counting.
...
**Preserver Scout** *(responding to Hana)*: We've preserved it. This tower was built by a civilization that chose to dissolve. In a generation, their work would have crumbled. Now it will endure forever. Every stone, every chisel mark. Exactly as it was.
...
**Preserver Agent** *(defeated)*: Grym's will is crystal. You can shatter us, but you cannot shatter that.
...
**Preserver Archivist** *(Gallery patrol)*: These moments are sacred. Grym hand-selected each one. You would destroy perfection to prove a point.
...
| Trigger | Khali (General) | Hark (Smith) | Orin (Millbrook) | Sera (Traveling) |
|---------|----------------|----------------|------------------|------------------|
...
**Khali** *(if Floriana recalled)*: New stock! Floriana's blessing brought herbs I've never seen before. Half-price on all plant-based consumables this week!

**Hark** *(if Tecton recalled)*: New ore from the mountains — Tecton cracked open veins I couldn't reach before. Check the new weapons.
...
### Hana Test — Reads as warm, practical, direct?
...
Pass: Hana consistently uses short sentences, active verbs, and occasional warmth without being flowery.

### Artun Test — Reads as kind, scholarly, measured?
...
Pass: Artun consistently uses longer, reflective sentences with historical references and gentle wisdom.

### Grym Test — Reads as elegant, calm, pained?
...
Pass: Grym consistently uses measured cadence, rhetorical structures, and never resorts to cruelty or gloating.

### Janik Test — Evolves from military to philosophical?
...
Pass: Janik's voice evolves across the three acts from orders to questions to declarations.
